...
import { getStudentSpaces } from '../../shared/redux/actions/student'
...
const Spaces = () => {
	...
	const studentSpaces = useSelector((state) => state.getStudentSpaces)
	const { loading, error, spaces } = studentSpaces
